 ...
 * SOFTWARE.  
 * 
 * @author Owen Derby, Dylan Sherry, and Ignacio Arnaldo
 */
...
public class SymbRegMOO {
    ...
    protected double minTarget, maxTarget;
    ...
    protected void step() throws GPException {
        ...
        try {
            ...
            System.err.print("Domination Counting exception");
        }
    ...
    */
    public Individual run_population() throws IOException {
        ...
        while ((generation <= NUM_GENS) && (!finished)) {
            ...
            try {
                ...
                System.err.format("Exception launched in run_population");
            }
    ...
    /**
     * Stop criteria - timeout reached?
     * @return whether to stop the run
     */
    ...
    /**
     * Static method to read Java properties files
     * @param propFile
     * @return 
     */
    ...
    protected void saveText(String filepath, String text, Boolean append) {
        try {
            ...
            System.err.print("Exception saving to text");
        }
    }
    
    /**
     * Get Function set
     * @return list of functions used to form arithmetic expressions
     */
    ...
    /**
     * Get Unary Function set (cos,log,exp ...)
     * @return list of unary functions used to form arithmetic expressions
     */
    ...
    /**
     * Check whether the algorithm is running
     * THis method is invoked from FlexGP's communication library
