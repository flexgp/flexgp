...
/**
 * This class evaluates GP-trees with the MRGP methodology. Please check:
...
public class SRLARSJava extends FitnessFunction {
    ...
    /**
     * Constructor that allows to specify the number of threads for parallel evaluation
     * @param aData
     * @param aPow
     * @param is_int
     * @param anumThreads 
    ...
    /**
     * Auxiliary thread class to perform parallel evaluation of the population
     * Each thread evaluates a subset of the populaiton
     */
    public class SRJavaThread extends Thread{
         ...
         * The subset is selected with the indices of the thread and that of individuals
         */
        @Override
        public void run(){
            int indexIndi = 0;
